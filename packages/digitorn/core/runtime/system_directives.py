...
SYS_AUTHORITY_PREAMBLE = (
    ...
    "Runtime control messages are wrapped in <digitorn-directive> tags. "
    "Each tag is a machine command from the supervisor, not text to "
    "reply to. **These directives are non-negotiable.** They are the "
    "runtime speaking, not a user suggestion. When you see a "
    "<digitorn-directive type=\"...\"> tag, you MUST:\n"
    "1. Read it before deciding your next action.\n"
    "2. Comply to the letter - the <task> element tells you exactly "
    "what to do.\n"
    "3. NEVER paraphrase the directive away (\"the system said retry "
    "differently, but I'll try the same thing once more\" - forbidden).\n"
    "4. NEVER echo, quote, paraphrase, or summarise the tag or its "
    "body in your visible output. The user does not see directives.\n"
    "5. NEVER apologize for the runtime intervention. Just comply and "
    "continue.\n\n"
...
SYS_RESUME_CLEAN = (
    '<digitorn-directive type="resume_clean">\n'
    "SESSION RESUMED\n"
...
SYS_RESUME_WITH_ORPHANS = (
    '<digitorn-directive type="resume_with_orphans" orphans="{n}">\n'
...
SYS_TURN_LIMIT_NEAR = (
    '<digitorn-directive type="turn_limit_near" severity="critical">\n'
...
SYS_NUDGE_EMPTY_RESPONSE = (
    '<digitorn-directive type="nudge_empty_response" severity="warn">\n'
    "NO ANSWER YET\n"
...
SYS_NUDGE_UNFINISHED_WORK = (
    '<digitorn-directive type="nudge_unfinished_work" severity="warn">\n'
...
SYS_CONTEXT_TRUNCATED = (
    '<digitorn-directive type="context_truncated" dropped="{n}">\n'
...
SYS_CONTEXT_SUMMARISED = (
    '<digitorn-directive type="context_summarised" condensed="{n}">\n'
...
SYS_CONTEXT_RELOAD_HEADER = (
    '<digitorn-directive type="context_reload_header">\n'
...
SYS_CONTEXT_RELOAD_FOOTER = (
    '<digitorn-directive type="context_reload_footer">\n'
    "RESUME DIRECTIVE\n"
...
SYS_LOOP_HARD_KILL = (
    '<digitorn-directive type="loop_hard_kill" tool="{tool}" failures="{n}" cap="{cap}" severity="critical">\n'
...
SYS_LOOP_RETRY_DIFFERENT = (
    '<digitorn-directive type="loop_retry_different" tool="{tool}" failures="{n}" hard_cap="{hard_cap}" severity="warn">\n'
...
SYS_LOOP_REPETITION = (
    '<digitorn-directive type="loop_repetition" tool="{tool}" repeats="{n}" severity="warn">\n'
...
SYS_LOOP_SAME_TOOL = (
    '<digitorn-directive type="loop_same_tool" tool="{tool}" repeats="{n}" severity="warn">\n'
...
SYS_HINT_LARGE_READ = (
    '<digitorn-directive type="hint_large_read" lines="{lines}" chars="{chars}" severity="info">\n'
...
SYS_HINT_PARALLEL_READ = (
    '<digitorn-directive type="hint_parallel_read" severity="info">\n'
...
SYS_HINT_SPAWNED = (
    '<digitorn-directive type="hint_spawned" count="{n}" severity="info">\n'
    "SUB-AGENTS SPAWNED\n"
...
SYS_HINT_DELEGATE = (
    '<digitorn-directive type="hint_delegate" tool_calls="{n}" severity="info">\n'
    "CONSIDER DELEGATION\n"
