...
def daemon_request(
    ...
    **kwargs: Any,
    ...
    The daemon URL is auto-detected from the request URL if not explicit.
    """
    # Auto-detect daemon URL from the full request URL
    if daemon == "http://127.0.0.1:8000" and "/api/" in url:
        daemon = url.split("/api/")[0]
