...
`packages/digitorn/modules/context_builder/`:
...
- App-config block reference (no direct config — implicit):
  [App Configuration](../../app-language/02-app-config.md)
- Tool injection modes (discovery vs direct):
  [Tool Injection](../../app-language/04-tools.md)
- Skills system (`use_skill`):
  [Skills System](../../app-language/21-skills.md)
- AskUser semantics + approval flow:
  [Security → Resolving a policy](../../app-language/11-security.md#resolving-a-policy)
- Watchers + scheduler:
