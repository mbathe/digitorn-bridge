...
without zombie state. See [Daemon resource protocol E2E](../_internal/daemon-resource-protocol.md) for the wire contract.
...
in `digitorn_web/src/components/chat/tool-call-block.tsx`; Flutter
has a single `_renderToolEntry` method in
