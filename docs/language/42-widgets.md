...
| Set | Count | Source |
|-----|-------|--------|
| `WIDGET_PRIMITIVES` | **43** | `schema.py` |
| `WIDGET_ACTIONS` | **15** | `schema.py` |
| `WIDGET_ACCENTS` | 6 | `schema.py` |
| `WIDGET_COLORS` | 9 | `schema.py` |
| `WIDGET_DENSITIES` | 3 | `schema.py` |
| `WIDGET_FILTERS` | ~25 | `schema.py` |
...
4. Dispatches user actions via
   `POST /api/apps/{id}/widgets/action` (`apps_v2/widgets.py`).
...
Verified at `schema.py`. Dispatched via
