...
Plus the OpenAPI spec for tooling:

- [`openapi.json`](openapi.json) - generated from FastAPI route handlers.
- [`schema-v1.json`](schema-v1.json) - the v1 YAML language JSON Schema.
...
versioned resources (notably `/api/apps_v2/`). v1 endpoints are
