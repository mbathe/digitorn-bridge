...
- **REST endpoints** — the daemon exposes
  ...
  integrations. See [API Integration → LSP](../../language/14-api-integration.md#lsp-language-server-proxy).
...
- LSP REST endpoints:
  [API Integration → LSP](../../language/14-api-integration.md#lsp-language-server-proxy)
