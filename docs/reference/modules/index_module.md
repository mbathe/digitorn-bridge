...
|----------|-------|--------|
| Module id | `index` | `module.py` |
| Version | `1.0.0` | `module.py` |
| Type | `system` (auto-injected, hidden from agents) | `module.py` |
| Config model | `IndexConfig` (`extra: forbid`) | `module.py` |
| Supported platforms | `Platform.ALL` | `module.py` |
