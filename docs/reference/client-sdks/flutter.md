...
| `error` | `_classify_error()` payload (see [Error classification](../../language/14-api-integration.md#error-classification)) | Turn-level error. |
...
[preview module](../modules/preview.md) for the full
reference.
...
`widget:*` events. See
[widget module](../modules/widget.md).
...
| ... | ... | The full REST surface lives in [API Integration](../../language/14-api-integration.md). |
...
- Comprehensive REST + Socket.IO reference (every
  endpoint cited): [API Integration](../../language/14-api-integration.md)
- Auth flow (where the JWT comes from):
  [Auth](../../language/22-auth.md)
- Approval gate semantics:
  [Security](../../language/11-security.md)
- Preview module + events:
  [preview reference](../modules/preview.md)
- Widget module + events:
  [widget reference](../modules/widget.md)
